...
export class FeaturePropertyController {
    ...
    async create(@Body() createFeaturepropertyDto: CreateFeaturepropertyDto) {
        try {
            await this.featurepropertyService.create(
    ...
    async findAll() {
        try {
            const data =
                await this.featurepropertyService.findAll();
            return {
                success: true,
                data,
    ...
    async findOne(@Param('id') id: string) {
        try {
            const data = await this.featurepropertyService.findOne(
                +id,
            );
            return {
                success: true,
    ...
    async update(@Param('id') id: string, @Body() updateFeaturepropertyDto: UpdateFeaturepropertyDto) {
        try {
            await this.featurepropertyService.update(
                +id,
